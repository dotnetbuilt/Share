        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProfileImages_Attachments_AttachmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikedStories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikedStories_Stories_StoryId",
                        column: x => x.StoryId,
                        principalTable: "Stories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LikedStories_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoryImages_Attachments_AttachmentId",
                        column: x => x.AttachmentId,
                        principalTable: "Attachments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikedStories_StoryId",
                table: "LikedStories",
                column: "StoryId");

            migrationBuilder.CreateIndex(
                name: "IX_LikedStories_UserId",
                table: "LikedStories",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoryImages_AttachmentId",
                table: "StoryImages",
                column: "AttachmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfileImages_AttachmentId",
